...
# Inhoud
- `Assets/`- Externe plaatjes gebruikt in het readme file
- `Data/raw/`- Gebruikte dataset van het onderzoek
- `Data/processed/`- Verwerkte data van dit onderzoek
- `Data_stewardship/`- Toepassing en gebruik van de github pagina
- `Scripts/`-  Het gebruikte R-studio script voor de dataverwerking
- `Bronnen/`- Ondersteunende literatuur van dit onderzoek
- `Resultaten/`- De verwerkte dataset in de vorm van grafieken en figuren
- `README.md`- De verwerkte informatie van dit onderzoek
...
*Figuur 3: Bias-analyse waarin in één oogopslag het verband te zien is hoe vaak genen worden gedetecteerd als DE met een groene trendlijn. Met op de x-as eigenschappen van de genen gebundeld in bins van 300, en op de y-as het aantal differentieel geëxprimeerde genen per bin. * 
...
*Figuur 5: Een KEGG-analyse van hsa04612 waarbij de controlegroep is vergeleken ten opzichte van de RA-groep. Veranderingen in het proces van deze antigen binding functie is te zien aan de kleur. Rood betekent dat de cel soort meer expressie en groen betekent een lagere expressie.* 
...
# Conclusie
In de [vulcanoplot](https://github.com/savvdzwld/casus-transcriptomics/blob/main/Resultaten/Vulcanoplot.png) is te zien dat ANKRD30BL een van de significant veranderde genen is.  Bij de [Bias-analyse](https://github.com/savvdzwld/casus-transcriptomics/blob/main/Resultaten/bias-analyse.png) is te zien dat de data biased is, aangezien de detectie als DE is toegenomen, wat een representatieve diagnose tegen houdt. Na het corrigeren van deze data is in de [go-analyse](https://github.com/savvdzwld/casus-transcriptomics/blob/main/Resultaten/go-analyse.png) geconstateerd dat het aantal gekoppelde genen aan het antigen binding proces significant verschilt bij RA-patiënten. Met de [KEGG-analyse](https://github.com/savvdzwld/casus-transcriptomics/blob/main/Resultaten/KEGG-analyse-hsa04612.pathview.png) is aangetoond dat er een hogere expressie HSP70 en HSP90 is bij patiënten met RA, HSP70 en HSP90  zijn betrokken  bij immuunregulatie en herstelprocessen. Wat inhoudt dat gezonde patiënten een immuunsysteem hebben met een hogere eiwitafbraak en antigeenbewerking. [(Wolfe et al. (2013))](https://github.com/savvdzwld/casus-transcriptomics/blob/main/Bronnen/HSP70%20%26%2090%20onderdrukken%20proteotoxiciteit.pdf) 
[(Krüger et al. (2019))](https://github.com/savvdzwld/casus-transcriptomics/blob/main/Bronnen/Role%20of%20heat%20shock%20proteins%2070%20%26%2090%20in%20exercise%20physiology.pdf)Deze verhogingen beïnvloeden de MHCI presentatie, de MHCI presentatie wordt verhoogd en lichaamseigen eiwitten worden afgebroken. Dit gedrag komt voor bij RA-patiënten. Wat betekent dat met gebruik van transcriptomics een RA diagnose te stellen is. Voor vervolg onderzoek zullen er meerdere functies onderzocht worden, wat een breder ziektebeeld zal vormen.
